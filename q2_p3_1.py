...
def send_from_P2PKH_transaction(amount_to_send,
    ...
    txin_scriptPubKey = P2MS_scriptPubKey(my_public_key)
...
if __name__ == '__main__':
    ######################################################################
    amount_owned = 0.015 # BTC
    amount_to_send = 0.0145
    txid_to_spend = ('5caa3fd775d9c0286a793667f4a905328cb7ba199f9e6e742a8032f3ad609e91') # TxHash of UTXO
